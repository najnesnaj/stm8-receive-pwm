                                      ...
                                      4 ; This file was generated Tue Jul 18 13:43:12 2017
                                      5 ;--------------------------------------------------------
      ...
      008530 A4 F7            [ 1] 1087 	and	a, #0xf7
      ...
      008553 A4 F7            [ 1] 1110 	and	a, #0xf7
      ...
      0087D8 F7               [ 1] 1551 	ld	(x), a
                                   1552 ;	se8r01-receive-pwm.c: 563: TIM2_PSCR =0X04;// 16 Mhz/2^4 =  1Mhz  -- the prescaler is a 4 bit number!
      0087D9 AE 53 0E         [ 2] 1553 	ldw	x, #0x530e
      0087DC A6 04            [ 1] 1554 	ld	a, #0x04
      0087DE F7               [ 1] 1555 	ld	(x), a
                                   1556 ;	se8r01-receive-pwm.c: 564: TIM2_ARRH =62500/256; // auto reload register
      0087DF AE 53 0F         [ 2] 1557 	ldw	x, #0x530f
      0087E2 A6 F4            [ 1] 1558 	ld	a, #0xf4
      0087E4 F7               [ 1] 1559 	ld	(x), a
                                   1560 ;	se8r01-receive-pwm.c: 565: TIM2_ARRL =62500%256; // 1000 Khz/62500 is 16 events per second (blink a led)
      0087E5 AE 53 10         [ 2] 1561 	ldw	x, #0x5310
      0087E8 A6 24            [ 1] 1562 	ld	a, #0x24
      0087EA F7               [ 1] 1563 	ld	(x), a
                                   1564 ;	se8r01-receive-pwm.c: 569: TIM2_CCR3H =31250/256; //compare capture register value
      0087EB AE 53 15         [ 2] 1565 	ldw	x, #0x5315
      0087EE A6 7A            [ 1] 1566 	ld	a, #0x7a
      0087F0 F7               [ 1] 1567 	ld	(x), a
                                   1568 ;	se8r01-receive-pwm.c: 570: TIM2_CCR3L =31250%256;
      0087F1 AE 53 16         [ 2] 1569 	ldw	x, #0x5316
      0087F4 A6 12            [ 1] 1570 	ld	a, #0x12
      0087F6 F7               [ 1] 1571 	ld	(x), a
                                   1572 ;	se8r01-receive-pwm.c: 574: TIM2_CR1 |=0x81;
      ...
      0087FE 81               [ 4] 1577 	ret
                                   1578 ;	se8r01-receive-pwm.c: 581: int main () {
                                   1579 ;	-----------------------------------------
                                   1580 ;	 function main
                                   1581 ;	-----------------------------------------
      0087FF                       1582 _main:
      0087FF 52 33            [ 2] 1583 	sub	sp, #51
                                   1584 ;	se8r01-receive-pwm.c: 583: UCHAR rx_addr_p1[]  = { 0xd2, 0xf0, 0xf0, 0xf0, 0xf0 };
      ...
      00881E E7 04            [ 1] 1603 	ld	(0x0004, x), a
                                   1604 ;	se8r01-receive-pwm.c: 584: UCHAR tx_addr[]     = { 0xe1, 0xf0, 0xf0, 0xf0, 0xf0 };
      ...
      008840 F7               [ 1] 1624 	ld	(x), a
                                   1625 ;	se8r01-receive-pwm.c: 589: InitializeSystemClock();
      008841 CD 81 E4         [ 4] 1626 	call	_InitializeSystemClock
                                   1627 ;	se8r01-receive-pwm.c: 590: InitializeUART();
      008844 CD 82 DC         [ 4] 1628 	call	_InitializeUART
                                   1629 ;	se8r01-receive-pwm.c: 592: InitializeSPI ();
      008847 CD 81 BC         [ 4] 1630 	call	_InitializeSPI
                                   1631 ;	se8r01-receive-pwm.c: 594: UARTPrintF("start debug \n\r");
      ...
      008851 5B 02            [ 2] 1635 	addw	sp, #2
                                   1636 ;	se8r01-receive-pwm.c: 596: memset (tx_payload, 0, sizeof(tx_payload));
      ...
      008861 5B 06            [ 2] 1645 	addw	sp, #6
                                   1646 ;	se8r01-receive-pwm.c: 599: init_io();                        // Initialize IO port
      008863 CD 83 55         [ 4] 1647 	call	_init_io
                                   1648 ;	se8r01-receive-pwm.c: 600: write_spi_reg(FLUSH_RX,0); // receive data 
      ...
      00886D 5B 02            [ 2] 1652 	addw	sp, #2
                                   1653 ;	se8r01-receive-pwm.c: 601: readstatus = read_spi_reg(CONFIG);
      00886F 4B 00            [ 1] 1654 	push	#0x00
      008871 CD 81 0A         [ 4] 1655 	call	_read_spi_reg
      008874 5B 01            [ 2] 1656 	addw	sp, #1
                                   1657 ;	se8r01-receive-pwm.c: 602: UARTPrintF("config = \n\r");
      ...
      0088BF 5B 02            [ 2] 1706 	addw	sp, #2
                                   1707 ;	se8r01-receive-pwm.c: 616: while (1) {
      0088C1                       1708 00110$:
                                   1709 ;	se8r01-receive-pwm.c: 618: if ((PD_IDR & (1 << 3))==0) //input low
      ...
      0088CC                       1715 00170$:
                                   1716 ;	se8r01-receive-pwm.c: 622: delay(240);
      ...
      0088D3 5B 02            [ 2] 1720 	addw	sp, #2
                                   1721 ;	se8r01-receive-pwm.c: 623: signal_lv=read_spi_reg(iRF_BANK0_RPD);
      ...
      0088DC C7 00 1A         [ 1] 1725 	ld	_signal_lv+0, a
                                   1726 ;	se8r01-receive-pwm.c: 624: status = read_spi_reg(STATUS);
      ...
      0088E6 C7 00 1D         [ 1] 1730 	ld	_status+0, a
                                   1731 ;	se8r01-receive-pwm.c: 626: if(status&STA_MARK_RX)                                                 // if receive data ready (TX_DS) interrupt
      0088E9 72 06 00 1D 02   [ 2] 1732 	btjt	_status+0, #6, 00171$
      0088EE 20 57            [ 2] 1733 	jra	00103$
      0088F0                       1734 00171$:
                                   1735 ;	se8r01-receive-pwm.c: 629: pip= (status & 0b00001110)>>1;
      ...
      0088F8 CF 00 1B         [ 2] 1741 	ldw	_pip+0, x
                                   1742 ;	se8r01-receive-pwm.c: 630: pload_width_now=read_spi_reg(iRF_CMD_R_RX_PL_WID);
      ...
      008904 CF 00 16         [ 2] 1748 	ldw	_pload_width_now+0, x
                                   1749 ;	se8r01-receive-pwm.c: 631: read_spi_buf(RD_RX_PLOAD, rx_buf,32);             // read playload to rx_buf
      ...
      008916 5B 04            [ 2] 1757 	addw	sp, #4
                                   1758 ;	se8r01-receive-pwm.c: 632: write_spi_reg(FLUSH_RX,0);
      ...
      00891F 5B 02            [ 2] 1762 	addw	sp, #2
                                   1763 ;	se8r01-receive-pwm.c: 634: newdata=1;
      008921 35 01 00 19      [ 1] 1764 	mov	_newdata+1, #0x01
      008925 72 5F 00 18      [ 1] 1765 	clr	_newdata+0
                                   1766 ;	se8r01-receive-pwm.c: 635: for (teller=0;teller<32;++teller)
      008929 5F               [ 1] 1767 	clrw	x
      00892A                       1768 00112$:
                                   1769 ;	se8r01-receive-pwm.c: 636: print_UCHAR_hex (rx_buf[teller]);
      ...
      008937 85               [ 2] 1777 	popw	x
                                   1778 ;	se8r01-receive-pwm.c: 635: for (teller=0;teller<32;++teller)
      008938 5C               [ 2] 1779 	incw	x
      008939 A3 00 20         [ 2] 1780 	cpw	x, #0x0020
      00893C 2F EC            [ 1] 1781 	jrslt	00112$
                                   1782 ;	se8r01-receive-pwm.c: 637: UARTPrintF("\n\r");
      ...
      008947                       1787 00103$:
                                   1788 ;	se8r01-receive-pwm.c: 640: write_spi_reg(WRITE_REG+STATUS,status);       // clear RX_DR or TX_DS or MAX_RT interrupt flag
      ...
      008951                       1793 00105$:
                                   1794 ;	se8r01-receive-pwm.c: 645: for (x1 = 0; x1 < 50; ++x1)
      ...
      00895E                       1802 00173$:
                                   1803 ;	se8r01-receive-pwm.c: 646: for (y1 = 0; y1 < 50; ++y1)
      ...
      008966 2E 19            [ 1] 1809 	jrsge	00122$
                                   1810 ;	se8r01-receive-pwm.c: 647: for (z1 = 0; z1 < 50; ++z1)
